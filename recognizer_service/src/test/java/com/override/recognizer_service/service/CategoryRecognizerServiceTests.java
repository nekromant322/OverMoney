...
public class CategoryRecognizerServiceTests {
  ...
  public void returnCorrectCategoryWhenKeywordMatched() {
    ...
    Assertions.assertEquals(
        categoryRecognizerService.recognizeCategory(message, List.of(categoryWithBeer)).getName(),
  ...
  public void doNotSuggestCategoryWhenAccuracyIsLow() {
    ...
    CategoryDTO recognizedCategory = categoryRecognizerService.recognizeCategory(message,
        List.of(categoryWithAnalgin));
    float accuracy = categoryRecognizerService.calculateLevenshteinDistance(message,
        keywordAnalgin.getName());
    Assertions.assertNull(
        recognizedCategory == null ? null : (accuracy < minAccuracy ? null : recognizedCategory));
  }
