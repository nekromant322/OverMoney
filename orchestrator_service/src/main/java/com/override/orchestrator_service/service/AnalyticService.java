...
public class AnalyticService {
    ...
    public List<AnalyticsDataDTO> getTotalCategorySumsForAnalytics(Long userId, Type type) throws InstanceNotFoundException {
        ...
        List<AnalyticsDataDTO> list = categoryRepository.findTotalSumOfAllCategoriesByAccIdAndType(accId, type);
        return list.stream()
                .filter(dto -> dto.getSumOfTransactions() != null)
                .peek(dto -> dto.setSumOfTransactions(Math.round(dto.getSumOfTransactions().doubleValue())))
