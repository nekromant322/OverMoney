...
public class TransactionHandlerImplSingleAmountAtFrontTest {
    ...
    private static Stream<Arguments> provideTransactions() {
        return Stream.of(
                ...
                Arguments.of("500 пиво теплое! 1.5", "пиво теплое! 1.5", 500f, "продукты"),
                Arguments.of("1000 ёлка", "ёлка", 1000f, null),
                Arguments.of("300,75 мёд", "мёд", 300.75f, "продукты"),
                Arguments.of("5000 самолёт", "самолёт", 5000f, null),
                Arguments.of("200 ёршик 150", "ёршик 150", 200f, null),
                Arguments.of("250 пчелиный мёд", "пчелиный мёд", 250f, "продукты")
        );
    }
}
