...
public class TransactionHandlerImplSingleAmountAtEndTest {
    ...
    private static Stream<Arguments> provideTransactions() {
        return Stream.of(
                ...
                Arguments.of("пиво теплое! 1.5 500.23", "пиво теплое! 1.5", 500.23, "продукты"),
                Arguments.of("пиво теплое! 1.5 500,23", "пиво теплое! 1.5", 500.23, "продукты"),
                Arguments.of("ёлка 1000", "ёлка", 1000, null),
                Arguments.of("мёд 300,75", "мёд", 300.75, "продукты"),
                Arguments.of("самолёт 5000", "самолёт", 5000, null),
                Arguments.of("ёршик 150 200", "ёршик 150", 200, null),
                Arguments.of("пчелиный мёд 250", "пчелиный мёд", 250, "продукты")
        );
    }
}
